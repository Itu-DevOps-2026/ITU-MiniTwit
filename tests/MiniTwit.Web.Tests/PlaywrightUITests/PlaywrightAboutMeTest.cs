...
public class PlaywrightAboutMeTest : PageTest
{
    ...
    public async Task ShowAboutMePageCorrectly()
    {
        ...
        //Following
        var following = Page.GetByRole(AriaRole.Cell, new() { Name = "Following", Exact = true })
        ...
        //Cheeps
        var cheeps = Page.GetByRole(AriaRole.Cell, new() { Name = "Cheeps", Exact = true })
            .Locator("xpath=following-sibling::td");
    ...
    public async Task FollowingAndUnfollowingIsShownCorrectly()
    {
        ...
        await Page.GetByRole(AriaRole.Cell, new() { Name = "Following", Exact = true })
            .ClickAsync();
        ...
        await Page.Locator("p")
            .Filter(
                ...
                {
                    HasText =
                        "Jacqualine Gilcoine Follow Starbuck now is what we hear the worst. — 8/1/2023 1",
                }
            )
        ...
        await Page.Locator("p")
            .Filter(
                ...
                {
                    HasText =
                        "Jacqualine Gilcoine Unfollow Starbuck now is what we hear the worst. — 8/1/2023",
                }
            )
            .GetByRole(AriaRole.Link)
            .Nth(1)
    ...
    public async Task FollowingMultiplePeople()
    {
        ...
        await Page.Locator("p")
            ...
            .ClickAsync();
        await Page.Locator("p")
            .Filter(new() { HasText = "Mellie Yost Follow But what" })
            .GetByRole(AriaRole.Link)
            .Nth(1)
            .ClickAsync();
        await Page.GetByRole(AriaRole.Link, new() { Name = "About me" }).ClickAsync();
        await Page.GetByRole(AriaRole.Cell, new() { Name = "Following" }).ClickAsync();
        await Page.GetByRole(AriaRole.Cell, new() { Name = "Jacqualine Gilcoine, Mellie" })
            .ClickAsync();

        //Checking that further following works as expected
        await Page.GetByRole(AriaRole.Link, new() { Name = "Public timeline" }).ClickAsync();
        await Page.Locator("p")
            .Filter(new() { HasText = "Malcolm Janski Follow At" })
            .GetByRole(AriaRole.Link)
            .Nth(1)
            .ClickAsync();
        await Page.Locator("p")
            .Filter(new() { HasText = "Wendell Ballan Follow As I" })
            .GetByRole(AriaRole.Link)
            .Nth(1)
            .ClickAsync();
        await Page.GetByRole(AriaRole.Link, new() { Name = "About me" }).ClickAsync();
        ...
        await Page.GetByRole(AriaRole.Link, new() { Name = "Public timeline" }).ClickAsync();
        await Page.Locator("p")
            .Filter(new() { HasText = "Mellie Yost Unfollow But what" })
            .GetByRole(AriaRole.Link)
            .Nth(1)
            .ClickAsync();
        await Page.Locator("p")
            .Filter(new() { HasText = "Malcolm Janski Unfollow At" })
            .GetByRole(AriaRole.Link)
            .Nth(1)
            .ClickAsync();
        await Page.GetByRole(AriaRole.Link, new() { Name = "About me" }).ClickAsync();
        await Page.GetByRole(AriaRole.Cell, new() { Name = "Following" }).ClickAsync();
        await Page.GetByRole(AriaRole.Cell, new() { Name = "Jacqualine Gilcoine, Wendell" })
            .ClickAsync();
    }
