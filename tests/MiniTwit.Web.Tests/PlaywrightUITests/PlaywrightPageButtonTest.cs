...
public class PlaywrightPageButtonTest : PageTest
{
    ...
    public async Task NextPreviousButtonsChangesPages()
    {
        ...
        await Expect(page)
            .ToHaveURLAsync("https://bdsa2024group8chirprazor2025.azurewebsites.net/?page=2");

        await page.GetByRole(AriaRole.Link, new() { Name = "next" }).ClickAsync();
        await Expect(page)
            .ToHaveURLAsync("https://bdsa2024group8chirprazor2025.azurewebsites.net/?page=3");

        await page.GetByRole(AriaRole.Link, new() { Name = "next" }).ClickAsync();
        await Expect(page)
            .ToHaveURLAsync("https://bdsa2024group8chirprazor2025.azurewebsites.net/?page=4");
        ...
        await Expect(page)
            .ToHaveURLAsync("https://bdsa2024group8chirprazor2025.azurewebsites.net/?page=20");

        await page.GetByRole(AriaRole.Link, new() { Name = "previous" }).ClickAsync();
        await Expect(page)
            .ToHaveURLAsync("https://bdsa2024group8chirprazor2025.azurewebsites.net/?page=19");

        await page.GetByRole(AriaRole.Link, new() { Name = "previous" }).ClickAsync();
        await Expect(page)
            .ToHaveURLAsync("https://bdsa2024group8chirprazor2025.azurewebsites.net/?page=18");
    }
}
